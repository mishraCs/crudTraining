                                                ...
                                                while ($subCategory = mysqli_fetch_assoc($sub_result)) { ?>
                                                    <li>
                                                        <div class="second_dropdown">
                                                            ...
                                                            <a tabindex="-1" href="sub_category_view.php?subCategoryId=<?php echo $subCategory['sub_category_id']; ?>&category=<?php echo $category['category_name']; ?>"><?php echo $subCategory['sub_category_name'] ?></a>
                                                        </div>
                                                    </li>
                                                <?php }
                                            } ?>
    ...
    <div class="profile_content">
        <div class="profile">
            <div class="profile_details">
                <img src="https://cactusthemes.com/blog/wp-content/uploads/2018/01/tt_avatar_small.jpg" alt="" />
                <div class="name_job">
