...
<div style="display:flex">
    <div class=" user_info container">
           ...
           <div class="col_div">
            ...
            $userId = $_SESSION['user_id'];
             ...
             if($result->num_rows >0 ){
              ...
              <!-- echo "<button onclick='window.location.href=\"add_to_cart.php?SubCategoryId=$subCategoryId\"' class='btn btn-success'>Add to cart</button>"; -->
        ...
        <div class="category_card col-md-6 ml-0 mr-0">
          <h4>Name: <b id="sub_category_name"><?php echo $subCategory['sub_category_name'] ?></b></h4>
          <h4>Price: <b id="sub_category_price"><?php echo $subCategory['sub_category_price'] ?></b></h4>
